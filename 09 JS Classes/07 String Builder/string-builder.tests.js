...
describe('StringBuilder', function () {
    ...
    describe('prototype', function () {
        it('properties exist', function () {
            assert.isFunction(StringBuilder.prototype.append,
                `StringBuilder prototype does not contain append `);

            assert.isFunction(StringBuilder.prototype.prepend,
                `StringBuilder prototype does not contain prepend `);

            assert.isFunction(StringBuilder.prototype.insertAt,
                `StringBuilder prototype does not contain insertAt `);

            assert.isFunction(StringBuilder.prototype.remove,
                `StringBuilder prototype does not contain remove `);

            assert.isFunction(StringBuilder.prototype.toString,
                `StringBuilder prototype does not contain toString `);
    ...
    describe('constructor', function () {
        it('with empty constructor', function () {
            ...
            assert.equal(result, '',
                `Must return empty string, but return ${result}`);
        });
    ...
    describe('_stringArray', function () {
        ...
        it('with empty contstructor', function () {
            let result = sb.toString();
